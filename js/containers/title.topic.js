export default class TopicTitle extends HTMLElement {
  constructor() {
  ...
  submitForm = async form => {
    ...
    form.addEventListener('submit', async e => {
      ...
      if (!data.name) {
        ...
        const errorMsg = 'Name must be defined!';
  ...
  getHeader = () => {
    return /* html */`
      <div class="top">
        <p class="desc">
          Update the name of the topic, this name will be used to identify the topic in the platform.
          Always ensure to use a name that match the topic's content and theme this will help users to easily identify the topic.
        </p>
      </div>
    `;
  }
    ...
    return /* css */`
      <style>
        ...
        *::-webkit-scrollbar {
        ...
        form.fields .field.bio .input-group.name {
          grid-column: 1/3;
          width: 100%;
        }
